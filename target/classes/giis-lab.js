...
this['giis-lab'] = function (_, Kotlin) {
  ...
  function waitDrawWu(context, i, x, y, e, change) {
    drawPixel(context, x, y);
    var a = Math.abs(e);
    if (e < 0) {
      drawAlfaPixel(context, a, x - change | 0, y);
    }
     else {
      drawAlfaPixel(context, a, x + change | 0, y);
    }
  ...
  function drawWu(source, target, canvas) {
    ...
    if (dx >= dy) {
      ...
      while (i <= dx) {
        ...
        x = x + changeX | 0;
        e += dy / dx;
        window.setTimeout(Kotlin.getCallableRef('waitDrawWu', function (context, i, x, y, e, change) {
          return waitDrawWu(context, i, x, y, e, change);
        }), 100 * i | 0, context, i, x, y, e, changeY);
        i = i + 1 | 0;
      }
    }
     else {
      ...
      while (i <= dy) {
        ...
        window.setTimeout(Kotlin.getCallableRef('waitDrawWu', function (context, i, x, y, e, change) {
          return waitDrawWu(context, i, x, y, e, change);
        }), 100 * i | 0, context, i, x, y, e, changeX);
        i = i + 1 | 0;
      }
    }
  }
  ...
  function render($receiver) {
    $receiver.clearRect(0.0, 0.0, Scene_getInstance().size * Scene_getInstance().scale, Scene_getInstance().size * Scene_getInstance().scale);
  ...
  package$giis.waitDrawWu_twwifs$ = waitDrawWu;
